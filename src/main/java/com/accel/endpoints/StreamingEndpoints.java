package com.accel.endpoints;

import com.accel.utils.MediaStreamer;
...
public class StreamingEndpoints {
    ...
    public StreamingEndpoints() {
// serve media from file system
        String MEDIA_FILE = "/Users/vyomkeshjha/IdeaProjects/Remote-Control-PC/reflectionserver/audio.mp3";
